...
objectCreator("assets/Video 1.mp4" , "Do you love me? 🫠" , "Say yes please" , "accept-btn" , "reject-btn1");
acceptProposal();
...
let container = document.querySelector(".container");
container.remove();
objectCreator("assets/Video 2.mp4" , "Please think again! 🙄" , "think again please😢" , "accept-btn" , "reject-btn2");
acceptProposal()
...
rejectBtn2.addEventListener("click" , () => {  
    let container = document.querySelector(".container");  
    container.remove();  
    objectCreator("assets/Video 3.mp4" , "say yes na! 😣" , "tang-ina mo😣" , "accept-btn" , "reject-btn3");  
    acceptProposal()  
    ...
    rejectBtn3.addEventListener("click" , () => {  
        let container = document.querySelector(".container");  
        container.remove();  
        objectCreator("assets/Video 4.mp4" , "please baby, say yes! 😭" , "king ina ka, sabihin mo nalang 'yes or no'! 😭 " , "accept-btn" , "reject-btn4");  
        acceptProposal()  
